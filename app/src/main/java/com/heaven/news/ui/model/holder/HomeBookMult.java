...
/**
 * FileName: com.heaven.news.ui.vm.holder.HomeBookMult.java
 * author: Heaven
 ...
 */
public class HomeBookMult extends BaseMultItem<BookData> {

    public HomeBookMult(@NonNull Class<BookData> modelBean, int itemLayoutId) {
    ...
    public boolean isTargetViewType(BookData item, int position) {
        return BookData.BOOK_MULT == item.bookType;
    }
}
