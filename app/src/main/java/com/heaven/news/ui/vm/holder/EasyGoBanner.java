 ...
 */
public class EasyGoBanner extends BaseMultItem<ImageInfo> {

    public EasyGoBanner(@NonNull Class<ImageInfo> modelBean, int itemLayoutId) {
    ...
    public void onBindViewHolder(@NonNull BaseViewHolder holder, @NonNull ImageInfo homeImageInfo) {
        ...
        if (TextUtils.isEmpty(homeImageInfo.pic)) {
            Glide.with(holder.context).load(R.mipmap.hint_banner).into(imageView);
        } else {
