...
public class flightSearchDomestic implements SOAPObject
{

    public flightSearchDomesticConditionVO _FLIGHT_SEARCH_CONDITION = null;
	        ...
	        while(event!= XmlPullParser.END_TAG){
	            ...
	            case XmlPullParser.START_TAG://判断当前事件是否是标签元素开始事件
	            	if("FLIGHT_SEARCH_CONDITION".equals(parser.getName())){
	                    flightSearchDomesticConditionVO soapObject = new flightSearchDomesticConditionVO();
