...
public class flightSearchDomesticConditionVO implements SOAPObject
{

    public String _CRM_MEMBER_ID = null;
    public String _QUERY_FLAG = null;
    ...
    public void addElementsToNode(XmlSerializer xml) throws IOException
    {
        ...
        if(_QUERY_FLAG != null) {
            xml.startTag(null, "QUERY_FLAG");
            xml.text(_QUERY_FLAG);
            xml.endTag(null, "QUERY_FLAG");
        }
		...
		try {
	        ...
	        while(event!= XmlPullParser.END_TAG){
	            ...
	            case XmlPullParser.START_TAG://判断当前事件是否是标签元素开始事件
	            	...
	            	else if("QUERY_FLAG".equals(parser.getName())){
	            		_QUERY_FLAG = parser.nextText();
	            		break;
	            	}
