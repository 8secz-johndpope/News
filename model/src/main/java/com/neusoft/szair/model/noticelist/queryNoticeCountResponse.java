...
public class queryNoticeCountResponse implements SOAPObject
{

    public noticeCountResultVO _NOTICE_COUNT = null;
    ...
    public void addElementsToNode(XmlSerializer xml) throws IOException
    {
        if(_NOTICE_COUNT != null) {
            ...
            _NOTICE_COUNT.addElementsToNode(xml);
	        ...
	        while(event!= XmlPullParser.END_TAG){
	            ...
	            case XmlPullParser.START_TAG://判断当前事件是否是标签元素开始事件
	            	if("NOTICE_COUNT".equals(parser.getName())){
	                    noticeCountResultVO soapObject = new noticeCountResultVO();
	                    soapObject.parse(binding, parser);
	                    _NOTICE_COUNT = soapObject;
	            		break;
	            	}
	            	else{
