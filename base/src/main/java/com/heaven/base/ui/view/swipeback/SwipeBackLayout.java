...
/**
 * FileName: com.heaven.base.ui.view.swipeback.SwipeBackLayout.java
 * author: Heaven
 * email: heavenisme@aliyun.com
 * date: 2019-05-13 15:10
 *
...
public class SwipeBackLayout extends ViewGroup {
     ...
     * 滑动返回时的阴影视图
     */
    private SwipBackShadowView mShadowView;
    /**
     * 内容视图
     */
    ...
    void attachToActivity(Activity activity) {
        ...
        mShadowView = new SwipBackShadowView(activity);
...
//        int widthSize = MeasureSpec.getSize(widthMeasureSpec);
        int widthSize = SwipeUiUtil.getRealScreenWidth(mActivity);
//        int heightSize = MeasureSpec.getSize(heightMeasureSpec);
        int heightSize = SwipeUiUtil.getRealScreenHeight(mActivity);
        // ======================== 新加的 END ========================
        ...
        // ======================== 新加的 START ========================
        if (!mIsNavigationBarOverlap && SwipeUiUtil.isPortrait(mActivity)) {
            maxLayoutHeight -= SwipeUiUtil.getNavigationBarHeight(mActivity);
        }

        if (mIsNavigationBarOverlap && !SwipeUiUtil.isPortrait(mActivity)) {
            widthSize += SwipeUiUtil.getNavigationBarHeight(mActivity);
        }
        // ======================== 新加的 END ========================
