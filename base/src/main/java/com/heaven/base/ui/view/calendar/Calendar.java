...
public final class Calendar implements Serializable, Comparable<Calendar> {
    ...
    private ArrayList<Calendar> daysInMounth;
    ...
    public ArrayList<Calendar> getDaysInMounth() {
        return daysInMounth;
    }

    public void setDaysInMounth(ArrayList<Calendar> daysInMounth) {
        this.daysInMounth = daysInMounth;
    }
