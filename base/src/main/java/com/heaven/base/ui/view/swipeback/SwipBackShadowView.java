package com.heaven.base.ui.view.swipeback;
...
/**
 * FileName: com.heaven.base.ui.view.swipeback.SwipBackShadowView.java
 * author: Heaven
 * email: heavenisme@aliyun.com
 * date: 2019-05-13 15:13
 *
 * @version V1.0 TODO <描述当前版本功能>
 */
public class SwipBackShadowView extends FrameLayout {
    private static final String TAG = SwipBackShadowView.class.getSimpleName();
    ...
    SwipBackShadowView(Activity activity) {
        super(activity);
        mActivity = activity;
    ...
    void unBindPreActivity(boolean isNeedAddImageView) {
        ...
        if (mPreDecorView != null && mPreContentView != null) {
            ...
            if (!(mPreContentView instanceof SwipeBackLayout)) {
                ...
                int height = mPreDecorView.getHeight() - SwipeUiUtil.getNavigationBarHeight(activity);
                if (!SwipeUiUtil.isPortrait(activity)) {
                    width = mPreDecorView.getWidth() - SwipeUiUtil.getNavigationBarHeight(activity);
    ...
    private Bitmap getBitmap(View view) {
        ...
        Bitmap bitmap = Bitmap.createBitmap(view.getDrawingCache(), 0, 0,
                SwipeUiUtil.getRealScreenWidth(mActivity),
                SwipeUiUtil.getRealScreenHeight(mActivity) - SwipeUiUtil.getNavigationBarHeight(mActivity));
